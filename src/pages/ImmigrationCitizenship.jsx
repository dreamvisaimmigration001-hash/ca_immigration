                      ...
                      <nav id="theme-nav" className="wb-navcurr-inited">
                        <div className="container">
                          ...
                          <button id="menu-btn" className="btn btn-primary" aria-controls="wb-auto-2" aria-expanded="false">
                            <span className="wb-inv">Toggle </span>Menu<ChevronDown size={16} />
                          </button>
                          <ul className="list-unstyled" id="wb-auto-2">
                            ...
                            <li><Link to="/world-monde">Canada and the world</Link></li>
                            <li><Link to="/finance">Money and finances</Link></li>
                            <li><Link to="/science">Science and innovation</Link></li>
                            <li><Link to="/indigenous-peoples">Indigenous Peoples</Link></li>
                            <li><Link to="/veterans-military">Veterans and military</Link></li>
              ...
              <div className="most-requested list-advanced list">
                    ...
                    <div className="highlight most-requested-highlight list-advanced list">
                      <ul id="most-requested-highlight-32e032cc71" className="cmp-list">
                        <li className="cmp-list__item">
                          <Link className="cmp-list__item-link" to="/immigration-refugees-citizenship/services/israel-west-bank-gaza-2023">
                            <span className="cmp-list__item-title">Gaza and the West Bank</span>
                          </Link>
                        </li>
                        <li className="cmp-list__item">
                          <Link className="cmp-list__item-link" to="/immigration-refugees-citizenship/services/haiti-2024">
                            <span className="cmp-list__item-title">Haiti</span>
                          </Link>
                        </li>
                        <li className="cmp-list__item">
                          <Link className="cmp-list__item-link" to="/immigration-refugees-citizenship/services/iran">
                            <span className="cmp-list__item-title">Iran</span>
                          </Link>
                        </li>
                        <li className="cmp-list__item">
                          <Link className="cmp-list__item-link" to="/immigration-refugees-citizenship/services/sudan2023">
                            <span className="cmp-list__item-title">Sudan</span>
                          </Link>
                        </li>
                        <li className="cmp-list__item">
                          <Link className="cmp-list__item-link" to="/immigration-refugees-citizenship/services/immigrate-canada/ukraine-measures">
                            <span className="cmp-list__item-title">Ukraine</span>
                          </Link>
                        </li>
                        <li className="cmp-list__item">
                          <Link className="cmp-list__item-link" to="/immigration-refugees-citizenship/services/special-measures/ebola-2026">
                            <span className="cmp-list__item-title">Ebola disease</span>
                          </Link>
                        </li>
                        <li className="cmp-list__item">
                          <Link className="cmp-list__item-link" to="/immigration-refugees-citizenship/services/special-measures">
                ...
                <section className="gc-most-requested">
                  <div className="container">
                    ...
                    <ul>
                      <li><Link to="/immigration-refugees-citizenship/services/application/check-status">Application status</Link></li>
                      <li><Link to="/immigration-refugees-citizenship/services/application/check-processing-times">Processing times</Link></li>
                    </ul>
                  </div>
                </section>
              </div>
                  ...
                  <div className="doormat-link-set panelcontainer">
                    <section className="gc-srvinfo">
                      ...
                      <div className="row wb-eqht wb-init wb-eqht-inited" id="wb-auto-3">
                        <div className="col-md-12" style={{ verticalAlign: 'top', minHeight: '85px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/application">Your IRCC application</Link></h3>
                    ...
                    <section className="gc-srvinfo">
                      ...
                      <div className="row wb-eqht wb-init">
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/visit-canada">Visit Canada</Link></h3>
                          <p>Electronic travel authorization (eTA), visitor visa, extend your visit</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/immigrate-canada">Live in Canada permanently</Link></h3>
                          <p>Express Entry, sponsorship, permanent residence (PR)</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '85px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/work-canada">Temporary work permits</Link></h3>
                          <p>Post-graduation work permit (PGWP), International Experience Canada (IEC)</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/study-canada">Study permits</Link></h3>
                          <p>Designated learning institutions (DLI), work while you study, extensions</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/refugees">Refugees and asylum</Link></h3>
                ...
                <div className="cmp-container container">
                  <div className="doormat-link-set panelcontainer">
                    <section className="gc-srvinfo">
                      ...
                      <div className="row wb-eqht wb-init">
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/canadian-citizenship">Canadian citizenship</Link></h3>
                          <p>Citizenship test, ceremony, proof of citizenship</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/permanent-residents">Permanent resident (PR) card</Link></h3>
                          <p>Renew or replace a lost or expired card, get your first card</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/canadian-passports">Passports</Link></h3>
                          <p>Adult and child passports, photos, other travel documents</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/settle-canada">Settling in Canada</Link></h3>
                          <p>Free services, find a job, benefits and taxes for newcomers</p>
                        </div>
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/canadians/adopt-child-abroad">International adoption</Link></h3>
                ...
                <div className="cmp-container container">
                  <div className="doormat-link-set panelcontainer">
                    <section className="gc-srvinfo">
                      ...
                      <div className="row wb-eqht wb-init">
                        <div className="col-md-6" style={{ verticalAlign: 'top', minHeight: '58px' }}>
                          <h3><Link to="/immigration-refugees-citizenship/services/protect-fraud">Fraud and scams</Link></h3>
                  ...
                  <div id="gc-pft" className="row wb-disable-allow wb-init wb-jsonmanager-inited">
                    <div className="col-sm-10 col-md-9 col-lg-8">
                      <section className="well mrgn-bttm-0">
                        ...
                        <form action="https://feedback-retroaction.canada.ca/api/QueueProblemForm" method="post" className="wb-postback wb-disable-allow wb-pii-scrub wb-init wb-postback-inited wb-pii-scrub-inited" id="wb-auto-6" data-wb-pii-blocked="true">
                          ...
                          <div className="gc-pft-thnk hide">
                            <p className="mrgn-tp-sm mrgn-bttm-0" role="status">
                              <Check className="text-success mrgn-rght-sm" aria-hidden="true" size={16} /> Thank you for your feedback.
                            </p>
                          </div>
                        </form>
                      </section>
