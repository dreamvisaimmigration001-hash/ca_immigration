...
export default function MyCICDashboard() {
  ...
  const applicantName = visa
    ? `${visa.givenNames || ""} ${visa.familyName || ""}`.trim()
    : "";
    ...
    if (Array.isArray(visa.document)) {
      visa.document.forEach((doc, idx) => {
        messagesList.push({
          id: doc._id || `MSG-${idx}`,
          subject:
            doc.name || visa.documentName || t("originalPassportRequest"),
          dateSent: dateSentStr,
          dateRead: dateSentStr,
          sender: t("senderIRCC"),
          content: t("messageContentText", {
            name: applicantName,
            appNum: appNumber,
          }),
          pdfUrl: doc.url,
    ...
    >
      ...
      >
        <main role="main" property="mainContentOfPage" id="wb-cont">
          ...
          <div
            className="row"
            style={{ marginBottom: "35px", display: "flex", flexWrap: "wrap" }}
          >
            ...
            >
              ...
              >
                ...
                >
                  <p style={{ marginBottom: "16px" }}>{t("processingDesc")}</p>
                  <p
                    style={{
                      fontWeight: "bold",
                      marginBottom: "6px",
                  ...
                  <p style={{ margin: 0 }}>
                    {visa?.latestUpdate ? (
                      <>
                        <strong>
                          {visa.latestUpdate.status} - {visa.latestUpdate.date}:
                        </strong>{" "}
                        {visa.latestUpdate.content}
                      </>
                    ) : (
                      <>
                        <strong>Final decision - August 14, 2026:</strong> Your
                        application has been approved. We sent you a message to
          ...
          <section style={{ marginBottom: "35px" }}>
            ...
            <div style={{ paddingLeft: "5px" }}>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                >
                  <li>
                    {visa?.documentReviewDate || "March 24, 2026"}{" "}
                    {t("docsReviewText")}
                  </li>
                </ul>
              </div>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                >
                  <li>
                    {visa?.latestUpdate?.date || "August 14, 2026"}{" "}
                    {t("finalDecisionText")}
                  </li>
                </ul>
              </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div>
                      <strong>{t("from")}:</strong> {selectedMessage.sender}
                    </div>
                    <div>
                      <strong>{t("dateSentLabel")}:</strong>{" "}
                  ...
                  <button
                    onClick={() => {
                      if (selectedMessage.pdfUrl) {
                        ...
                        alert(
                          `Opening ${selectedMessage.subject} in a new tab...`,
                        );
                      }
                    }}
                    style={{
